...
//    	iList.add(null);
    	...
    	System.out.println("********************");
    	// CHANGED: iList.reversed() is a SequencedCollection method (Java 21+).
    	// Java 17 alternative: make a copy and use Collections.reverse() on it,
    	// so the original iList order stays untouched.
    	List<Integer> list = new ArrayList<>(iList);
    	Collections.reverse(list);
    	list.forEach(i->System.out.println(i));
    	System.out.println("********************");
    	// CHANGED: addFirst()/addLast() are SequencedCollection methods (Java 21+).
    	// Java 17 alternative: add(0, element) for front insert, add(element) for end insert.
    	iList.add(0, 67);
    	iList.add(90);
    	iList.forEach(i->System.out.println(i));
    	System.out.println("********************");
