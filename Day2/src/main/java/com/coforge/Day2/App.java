...
//        iList.add(null);
        ...
        System.out.println("********************");
        // Java 17 compatible way to reverse (instead of iList.reversed())
        List<Integer> list = new ArrayList<>(iList);
        Collections.reverse(list);
        list.forEach(i -> System.out.println(i));
        System.out.println("********************");

        // Java 17 compatible way (instead of addFirst()/addLast())
        iList.add(0, 67);
        iList.add(iList.size(), 90);
        iList.forEach(i -> System.out.println(i));
        System.out.println("********************");
        ...
        System.out.println("***************");
        ListIterator<Integer> itr2 = iList.listIterator();
        while (itr2.hasNext())
